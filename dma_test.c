...
void app_done ()
{
  ...
  // report number of scheduled DMA transfers
  io_printf (IO_BUF, "[core %d] scheduled %d DMA transfers\n", coreID, count);

  // report number of scheduled DMA transfers
  //io_printf (IO_BUF, "[core %d] scheduled %d DMA transfers (val=3)\n", coreID, count2);

  // report number of scheduled DMA transfers
  //io_printf (IO_BUF, "[core %d] failed %d DMA transfers (val=3)\n", coreID, count_failed);
